package net.bianchen.spring_boot_redis.tools;
...
public final class RedisUtil {
	...
	public Object rightPopAndLeftPush(final String key, final String destinationKey) {
		Object value = redisTemplate.opsForList().rightPopAndLeftPush(key, destinationKey);
		return value;
	}
	...
	public String rightPop(final String key, final long timeout, final TimeUnit unit) {
